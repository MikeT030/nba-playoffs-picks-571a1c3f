        ...
        <div className="relative flex items-center justify-center gap-1">
          {[
            ...
            <div key={label} className="flex items-center">
              {/* Separator colon */}
              {i > 0 && (
                <span className="font-digital text-2xl md:text-3xl text-primary mx-1 drop-shadow-[0_0_12px_hsl(var(--primary)/0.8)] animate-pulse">
                  :
                </span>
              )}
              <div className="flex flex-col items-center">
                ...
                <div className="bg-[#111] rounded border border-[#2a2a2a] px-2 py-1 shadow-[inset_0_2px_8px_rgba(0,0,0,0.6)]">
                  <span className="font-digital text-3xl md:text-4xl text-primary tracking-widest tabular-nums drop-shadow-[0_0_12px_hsl(var(--primary)/0.8)]"
                    style={{ textShadow: "0 0 10px hsl(var(--primary) / 0.6), 0 0 20px hsl(var(--primary) / 0.3)" }}
                  >
                    {pad(val)}
                  </span>
                </div>
