...
export interface SeriesGame {
  ...
  /** Number of overtime periods if game went to OT */
  ot?: number;
}
...
// Game 2 went to 2OT (period 6), Game 6 went to OT (period 5)
export const chaMiaSeriesGames: SeriesGame[] = [
  ...
  { gameNumber: 2, date: "Apr 21", status: "final", homeTeam: MIA, awayTeam: CHA, homeScore: 102, awayScore: 110, seriesRecord: [1, 1], ot: 2 },
  ...
  { gameNumber: 6, date: "May 1",  status: "final", homeTeam: CHA, awayTeam: MIA, homeScore: 118, awayScore: 109, seriesRecord: [3, 3], ot: 1 },
