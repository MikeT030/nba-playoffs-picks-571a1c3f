...
const SeriesCard = ({
  ...
  return (
    <div className={`rounded-lg border border-white/10 backdrop-blur-md p-3.5 bg-[#191d24] ${locked ? "opacity-50" : ""}`}>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full font-body text-sm font-medium transition-all duration-200 flex items-center gap-2 ${
                      selectedRound === round
                        ? "bg-primary/15 text-primary border border-primary/40"
                        : unlocked
                          ? "bg-transparent text-[#dce0e5] border border-[#dce0e5]"
                          : "bg-transparent text-[#dce0e5]/50 cursor-not-allowed border border-[#dce0e5]/50"
                    }`}
                  >
                    {round}
