    ...
    >
      ...
      <div className="p-5 flex items-center justify-between gap-2 pt-[20px]">
        ...
        <div className="flex-1 flex items-center gap-1.5 -translate-y-2">
          ...
          <div>
            <p className="tracking-wide text-lg font-light" style={{ fontFamily: "'Saira Stencil One', sans-serif" }}>{displayAway.abbreviation}</p>
...
            <p className="tracking-wide text-lg font-light" style={{ fontFamily: "'Saira Stencil One', sans-serif" }}>{displayHome.abbreviation}</p>
