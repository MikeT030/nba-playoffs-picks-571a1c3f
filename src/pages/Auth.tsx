...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Form */}
      <div className="flex-1 flex items-start justify-center px-4 -mt-[108px] relative z-10">
        <div className="w-full max-w-sm space-y-8">
          <div className="text-center">
            ...
            >
              ...
              <br />
              <span className="font-bold text-5xl block leading-[1.15]" style={{ fontFamily: "'Claymale', 'Archivo Black', sans-serif" }}>Playoffs</span>
              <span className="font-bold text-5xl block leading-[1.15]" style={{ fontFamily: "'Claymale', 'Archivo Black', sans-serif" }}>Picks</span>
            </h1>
            <p className="font-body mt-3 text-lg font-normal text-secondary-foreground whitespace-pre-line">{subtitle}</p>
          </div>

          {step === "forgot" ? (
            <form key="forgot-form" onSubmit={handleForgotPassword} className="space-y-8 mt-[30px]">
              <Input
                type="email"
                placeholder="Email"
                value={email}
            ...
            <form key="email-form" onSubmit={handleEmailSubmit} className="space-y-8 mt-[30px]">
              <Input
                type="email"
            ...
            <form key="password-form" onSubmit={handlePasswordSubmit} className="space-y-8 mt-[30px]">
              <div className="text-center">
