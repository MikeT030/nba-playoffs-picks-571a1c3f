...
const HeroBanner = ({ title = "2026 Playoffs Picks", subtitle = "2026 Playoffs" }: HeroBannerProps) => {
  return (
          ...
          <div className="flex items-stretch gap-5 py-[20px]">
            ...
            <div className="min-w-0 relative flex-1 flex flex-col justify-between h-[6.6rem] md:h-[8.8rem]">
              ...
              <div className="flex flex-col justify-center flex-1 py-2">
                ...
                <h1
                  className="md:text-5xl tracking-wider leading-[1.05] whitespace-pre-line text-4xl font-medium"
