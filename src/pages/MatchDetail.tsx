        ...
        <div className="relative container py-6">
          ...
          <div className="flex items-center justify-between gap-6 pt-[4px]">
            ...
            <div className="flex-1 text-center flex flex-col items-center relative">
              {displayAway.seed && (
                <span className="absolute left-0 top-1/2 -translate-y-1/2 text-sm text-muted-foreground font-body font-semibold">{displayAway.seed}</span>
              )}
            ...
            <div className="flex-1 text-center flex flex-col items-center relative">
              {displayHome.seed && (
                <span className="absolute right-0 top-1/2 -translate-y-1/2 text-sm text-muted-foreground font-body font-semibold">{displayHome.seed}</span>
              )}
