...
const MyPicks = () => {
  ...
  if (authLoading || loading) {
    return (
      <div className="min-h-screen bg-background pb-28">
        <HeroBanner title={"My Picks"} subtitle="2026 Playoffs" />
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      <HeroBanner title={"My Picks"} subtitle={profileName ? `${profileName}'s ${bets.length}` : `2026 Playoffs · ${bets.length} picks`} />
      ...
      <section className="container py-8 pb-24">
        ...
        <Accordion type="single" collapsible className="mb-12">
          <AccordionItem value="cards" className="border-none group">
            <AccordionTrigger className="w-full hover:no-underline py-2 flex-col items-stretch gap-4 relative [&>svg]:absolute [&>svg]:right-0 [&>svg]:top-4 [&>svg]:h-6 [&>svg]:w-6 [&>svg]:z-10">
