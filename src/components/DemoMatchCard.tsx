      ...
      <div className="p-5 flex items-center gap-4 pt-[20px]">
        ...
        <div className="text-center px-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xl font-medium" style={{ fontFamily: "'Orbitron', sans-serif" }}>{awayScore}</span>
            <span className="text-muted-foreground font-body text-sm">—</span>
            <span className="text-xl font-medium" style={{ fontFamily: "'Orbitron', sans-serif" }}>{homeScore}</span>
          </div>
