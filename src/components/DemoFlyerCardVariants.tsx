        ...
        <div className="relative aspect-[3/4] w-full">
          ...
          <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <div className="rounded-l-full rounded-r-none bg-[#E4E2F1] px-2.5 py-1.5 shadow-md">
                <TeamLogo src={PHX_LOGO} alt="PHX" className="w-7 h-7" />
              </div>
              <div className="rounded-r-full rounded-l-none bg-[#E4E2F1] px-2.5 py-1.5 shadow-md">
