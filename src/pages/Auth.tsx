          ...
          {step === "forgot" ? (
            <form key="forgot-form" onSubmit={handleForgotPassword} className="space-y-8">
              <Input
                ...
                required
                className="font-body border-0 border-b border-white rounded-none bg-transparent px-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-center text-xl"
              />
              <button
                type="submit"
                disabled={loading}
