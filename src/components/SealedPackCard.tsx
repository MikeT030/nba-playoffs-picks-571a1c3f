      ...
      >
        ...
        <style>{`
          ...
          .sealed-pack-burn {
            ...
            transition: -webkit-mask-position 2240ms cubic-bezier(0.65, 0, 0.35, 1),
                        mask-position 2240ms cubic-bezier(0.65, 0, 0.35, 1);
          }
          ...
          .sealed-pack-ember {
            ...
            animation: ember-sweep 2240ms cubic-bezier(0.65, 0, 0.35, 1) forwards;
          }
