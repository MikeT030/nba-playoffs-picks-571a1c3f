...
const FullPackFace = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-0 text-left px-2 z-10" style={{ top: "calc(12% - 6px)" }}>
        <h1
          className="font-display italic leading-[0.95] tracking-tight flex flex-col items-start text-5xl"
          style={{
      ...
      <div className="absolute left-[5%] z-10" style={{ bottom: "calc(7% + 95px)" }}>
        <div
